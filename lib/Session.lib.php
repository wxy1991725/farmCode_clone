...
class Session {
    ...
    static function _init() {
        ...
        $SessionConfig = Lib_Config::GetConfig('session');
        Session::setCookieDomain($SessionConfig['COOKIE_DOMAIN']);
        //设置当前项目运行脚本作为Session本地名
        Session::localName($SessionConfig['SESSION_LOCAL_NAME']);
        Session::name($SessionConfig['SESSION_NAME']);
        Session::path($SessionConfig['SESSION_PATH']);
        //Session::setCallback($SessionConfig['SESSION_LOCAL_NAME']);
    }
    ...
    static function start() {
        ...
        Session::setExpire(Lib_Config::GetConfig('session.SESSION_EXPIRE'));
    }
